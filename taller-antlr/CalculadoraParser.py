...
def serializedATN():
    return [
        ...
        1,6,1,1,0,0,0,7,8,6,1,-1,0,8,9,5,5,0,0,9,24,1,0,0,0,10,11,10,5,0,
        0,11,12,5,1,0,0,12,23,3,2,1,6,13,14,10,4,0,0,14,15,5,2,0,0,15,23,
        3,2,1,4,16,17,10,3,0,0,17,18,5,3,0,0,18,23,3,2,1,4,19,20,10,2,0,
        0,20,21,5,4,0,0,21,23,3,2,1,3,22,10,1,0,0,0,22,13,1,0,0,0,22,16,
        ...
        try:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = CalculadoraParser.SumaContext(self, CalculadoraParser.ExprContext(self, _parentctx, _parentState))
                        ...
                        localctx = CalculadoraParser.RestaContext(self, CalculadoraParser.ExprContext(self, _parentctx, _parentState))
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_expr)
                        self.state = 13
                        ...
                        localctx = CalculadoraParser.MultiplicacionContext(self, CalculadoraParser.ExprContext(self, _parentctx, _parentState))
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_expr)
                        self.state = 16
                        ...
                        localctx = CalculadoraParser.DivisionContext(self, CalculadoraParser.ExprContext(self, _parentctx, _parentState))
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_expr)
                        self.state = 19
